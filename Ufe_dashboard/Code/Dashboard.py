...
# ============================================================
    ...
    pct_kpis = [
        ...
        ("Хувь", "Солилцооны хөтөлбөрт хамрагдсан багшийн эзлэх хувь",    "🔄 Солилцоо хөтөлбөрт хамрагдсан",            C["pink"]),
        ("Хувь", "Төсөл удирдсан багшийн эзлэх хувь",                      "📁 Төсөл удирдсан",               C["orange"]),
        ("Хувь", "Хамтарсан судалгаа, төсөлд оролцсон багшийн эзлэх хувь","🤝 Судалгаанд оролцосон",            C["teal"]),
