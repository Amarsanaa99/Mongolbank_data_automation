...
if st.session_state.page == "teacher":
    ...
    pct_kpis = [
        ...
        ("Хувь", "Гадаад хэлээр заах чадвартай багшийн эзлэх хувь",        "🗣️ Гадаад хэлээр заах чадвартай багш",         C["purple"]),
        ("Хувь", "Солилцооны хөтөлбөрт хамрагдсан багшийн эзлэх хувь",    "🔄 Солилцооны хөтөлбөрт хамрагдсан багш",            C["pink"]),
        ("Хувь", "Төсөл удирдсан багшийн эзлэх хувь",                      "📁 Төсөл удирдсан багш",               C["orange"]),
        ("Хувь", "Хамтарсан судалгаа, төсөлд оролцсон багшийн эзлэх хувь","🤝 Хамтарсан, судалгаа төсөл хөтөлбөрт оролцосон",            C["teal"]),
        ("Хувь", "h-индекстэй багшийн эзлэх хувь",                         "📊 h-индекстэй багш",            C["blue"]),
        ("Хувь", "WOS, Scopus-д өгүүлэл хэвлүүлсэн багшийн эзлэх хувь",  "📰 WOS/Scopus өгүүлэл хэвлүүлсэн багш",          C["purple"]),
    ]
...
padding:12px 10px;text-align:center;margin-bottom:8px;border-top:2px solid {clr};'>
    ...
    <div style='color:#4a6a98;font-size:13px;margin-top:3px;'>{lbl}</div>
...
# ============================================================
    ...
    TOP_COUNT_KPIS = [
        ...
        ("Эрдэм шинжилгээний ажилтны тоо",                "👩‍🔬 ЭШ ажилтан",      C["teal"]),
        ("Эрдэм шинжилгээний бүтээлд оролцсон багшийн тоо","👨‍🏫 ЭШ бүтээлд оролцсон багш",   C["purple"]),
        ("ОУ импакт өндөртэй сэтгүүлд нийтлүүлсэн бүтээлийн тоо", "⭐ ОУ импакт өндөртэй сэтгүүл нийтлүүлсэн", C["orange"]),
        ("ОУ сэтгүүлд нийтлүүлсэн бүтээлийн тоо",         "📰 ОУ сэтгүүлд нийтлүүлсэн",       C["green"]),
        ("Гадаадын эрдэмтэдтэй хамтарсан бүтээлийн тоо",  "🌍 Гадаадын эрдэмтэдтэй хамтарсан бүтээл",        C["pink"]),
