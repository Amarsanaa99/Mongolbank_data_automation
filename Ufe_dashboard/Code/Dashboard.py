...
# ============================================================
    ...
    pct_kpis = [
        ...
        ("Хувь", "Гадаад хэлээр заах чадвартай багшийн эзлэх хувь",        "🗣️ Гадаад хэлээр заах чадвартай",         C["purple"]),
        ("Хувь", "Солилцооны хөтөлбөрт хамрагдсан багшийн эзлэх хувь",    "🔄 Солилцооны хөтөлбөрт хамрагдсан",            C["pink"]),
        ("Хувь", "Төсөл удирдсан багшийн эзлэх хувь",                      "📁 Төсөл, хөтөлбөр удирдсан багш",               C["orange"]),
        ("Хувь", "Хамтарсан судалгаа, төсөлд оролцсон багшийн эзлэх хувь","🤝 Хамтарсан, судалгаанд оролцосон",            C["teal"]),
        ("Хувь", "h-индекстэй багшийн эзлэх хувь",                         "📊 h-индекс зэрэгтэй багш",            C["blue"]),
        ("Хувь", "WOS, Scopus-д өгүүлэл хэвлүүлсэн багшийн эзлэх хувь",  "📰 WOS/Scopus өгүүлэл хэвлүүлсэн",          C["purple"]),
    ]
